import { iPhoneSettingsConstants, iPhoneWithWidgetsSettingsConstants, iPadSettingsConstants, letterSettingsConstants, a4SettingsConstants } from "../constants/developer-settings-constants";

export function getDisplayConstant(device: string, widget: boolean) {
    let constantDevice;
    switch (device) {
        case "ipad":
